    ...
    public void guardarExcelSalida() {
        ...
        try {
            ...
            if (txfRuta.getText().length() == 0) {
                ...
                String cedula = VistaSGI.txfBuscarConsultarSalida.getText();
                ...
                if (VistaSGI.tablaConsultarSalidas.getRowCount() == 0) {
                    ...
                    generar.crearExcelSalidasDetallado(txfRuta.getText(), motivo, fechaInicio, fechaFin, cedula);
                    JOptionPane.showMessageDialog(null, "El archivo se ha guardado y se abrirá en breve...");
                    txfRuta.setText(null);
                    dispose();
                    ...
                    generar.crearExcelSalidasEspecifico(txfRuta.getText(), VistaSGI.tablaConsultarSalidas.getValueAt(VistaSGI.tablaConsultarSalidas.getSelectedRow(), 0).toString());
                    JOptionPane.showMessageDialog(null, "El archivo se ha guardado y se abrirá en breve...");
                    txfRuta.setText(null);
                    dispose();
                }
