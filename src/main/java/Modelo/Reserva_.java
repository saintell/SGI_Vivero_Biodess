...
public class Reserva_ {
    ...
    public Reserva_(int codigo_reserva, String id_cliente, int codigo_planta, String tamaño_bolsa, String rango, int cantidad, int costo, Date fechaApertura, Date fechaCierre) {
